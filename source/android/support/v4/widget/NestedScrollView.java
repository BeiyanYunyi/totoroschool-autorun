  ...
  implements NestedScrollingChild2, NestedScrollingParent2, ScrollingView
{
  ...
  protected int computeScrollDeltaToGetChildRectOnScreen(Rect paramRect)
  {
    ...
    if ((paramRect.bottom > j) && (paramRect.top > i))
    {
      ...
      return Math.min(i, localView.getBottom() + localLayoutParams.bottomMargin - k);
    }
    k = m;
    if (paramRect.top < i)
    {
  ...
  public boolean pageScroll(int paramInt)
  {
    ...
    if (i != 0)
    {
      ...
      if (i > 0)
      {
        View localView = getChildAt(i - 1);
        FrameLayout.LayoutParams localLayoutParams = (FrameLayout.LayoutParams)localView.getLayoutParams();
        i = localView.getBottom() + localLayoutParams.bottomMargin + getPaddingBottom();
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\widget\NestedScrollView.class
