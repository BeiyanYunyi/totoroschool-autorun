  ...
  implements NestedScrollingChild, NestedScrollingParent
{
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    paramInt1 /= 2;
    paramInt3 /= 2;
    ((CircleImageView)localObject).layout(paramInt1 - paramInt3, this.mCurrentTargetOffsetTop, paramInt1 + paramInt3, this.mCurrentTargetOffsetTop + paramInt2);
  }
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\widget\SwipeRefreshLayout.class
