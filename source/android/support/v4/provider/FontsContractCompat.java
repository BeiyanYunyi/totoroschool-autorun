    ...
    paramFontRequest = new Callable()
    {
        ...
        throws Exception
      {
        ...
        if (localTypefaceResult.mTypeface != null) {
          FontsContractCompat.sTypefaceCache.put(localObject, localTypefaceResult.mTypeface);
        }
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\provider\FontsContractCompat.class
