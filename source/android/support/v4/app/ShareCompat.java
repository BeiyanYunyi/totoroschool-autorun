...
public final class ShareCompat
{
  ...
  public static class IntentBuilder
  {
    ...
    public Intent getIntent()
    {
      ...
      int i = 1;
      if ((localArrayList == null) || (this.mStreams.size() <= 1)) {
        i = 0;
      }
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\app\ShareCompat.class
