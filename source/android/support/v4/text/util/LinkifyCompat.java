...
public final class LinkifyCompat
{
  ...
  private static void gatherMapLinks(ArrayList<LinkSpec> paramArrayList, Spannable paramSpannable)
  {
    ...
    //   35: dup
    //   36: invokespecial 258	android/support/v4/text/util/LinkifyCompat$LinkSpec:<init>	()V
    //   39: astore 5
    //   41: aload 6
    //   43: invokevirtual 278	java/lang/String:length	()I
    //   46: iload 4
    //   48: iadd
    //   49: istore_3
    //   50: aload 5
    ...
    //   54: iload_2
    //   55: iadd
    //   56: putfield 177	android/support/v4/text/util/LinkifyCompat$LinkSpec:start	I
    //   59: iload_2
    //   60: iload_3
    //   61: iadd
    //   62: istore_2
    //   63: aload 5
    //   65: iload_2
    //   66: putfield 180	android/support/v4/text/util/LinkifyCompat$LinkSpec:end	I
    //   69: aload_1
    //   70: iload_3
    //   71: invokevirtual 281	java/lang/String:substring	(I)Ljava/lang/String;
    //   74: astore_1
    //   75: aload 6
    //   77: ldc_w 283
    //   80: invokestatic 289	java/net/URLEncoder:encode	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   83: astore 6
    //   85: new 291	java/lang/StringBuilder
    //   88: dup
    //   89: invokespecial 292	java/lang/StringBuilder:<init>	()V
    //   92: astore 7
    //   94: aload 7
    //   96: ldc_w 294
    ...
    //   103: aload 7
    //   105: aload 6
    //   107: invokevirtual 298	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   110: pop
    //   111: aload 5
    //   113: aload 7
    //   115: invokevirtual 299	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   118: putfield 173	android/support/v4/text/util/LinkifyCompat$LinkSpec:url	Ljava/lang/String;
    //   121: aload_0
    //   122: aload 5
    //   124: invokevirtual 262	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   127: pop
    //   128: goto -121 -> 7
    //   131: return
    //   132: astore_0
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\text\util\LinkifyCompat.class
