...
class AlertController
{
  ...
  {
    View localView = this.mWindow.findViewById(R.id.scrollIndicatorUp);
    final Object localObject1 = this.mWindow.findViewById(R.id.scrollIndicatorDown);
      ...
      if ((paramView != null) || (localObject1 != null))
      {
        if (this.mMessage != null)
        {
          this.mScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener()
          {
            ...
            {
              AlertController.manageScrollIndicators(paramAnonymousNestedScrollView, paramView, localObject1);
            }
          });
          this.mScrollView.post(new Runnable()
          {
            public void run()
            {
              AlertController.manageScrollIndicators(AlertController.this.mScrollView, paramView, localObject1);
            }
          });
          return;
        }
        if (this.mListView != null)
        {
          this.mListView.setOnScrollListener(new AbsListView.OnScrollListener()
          {
            ...
            {
              AlertController.manageScrollIndicators(paramAnonymousAbsListView, paramView, localObject1);
            }
          ...
          this.mListView.post(new Runnable()
          {
            public void run()
            {
              AlertController.manageScrollIndicators(AlertController.this.mListView, paramView, localObject1);
            }
          });
          return;
        }
  ...
  private void setupView()
  {
    ...
    if ((this.mListView instanceof RecycleListView)) {
      ((RecycleListView)this.mListView).setHasDecor(k, bool);
    }
    if (i == 0)
    {
      if (this.mListView != null) {
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\app\AlertController.class
