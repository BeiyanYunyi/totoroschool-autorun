  ...
  implements NestedScrollingParent, DecorContentParent
{
  ...
  public void onWindowSystemUiVisibilityChanged(int paramInt)
  {
    ...
    if (this.mActionBarVisibilityCallback != null)
    {
      this.mActionBarVisibilityCallback.enableContentAnimations(j ^ 0x1);
      if ((i == 0) && (j != 0)) {
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\ActionBarOverlayLayout.class
