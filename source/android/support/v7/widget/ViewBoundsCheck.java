...
class ViewBoundsCheck
{
  ...
  static class BoundFlags
  {
    ...
    boolean boundsMatch()
    {
      ...
      if (((this.mBoundFlags & 0x70) != 0) && ((this.mBoundFlags & compare(this.mChildStart, this.mRvEnd) << 4) == 0)) {
        return false;
      }
      if (((this.mBoundFlags & 0x700) != 0) && ((this.mBoundFlags & compare(this.mChildEnd, this.mRvStart) << 8) == 0)) {
        return false;
      }
      return ((this.mBoundFlags & 0x7000) == 0) || ((this.mBoundFlags & compare(this.mChildEnd, this.mRvEnd) << 12) != 0);
    }
    ...
    {
      this.mBoundFlags = (paramInt1 & paramInt2 | this.mBoundFlags & (paramInt2 ^ 0xFFFFFFFF));
    }
  }
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\ViewBoundsCheck.class
