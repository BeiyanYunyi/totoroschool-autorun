...
class AppCompatTextViewAutoSizeHelper
{
  ...
  private boolean suggestedSizeFitsInSpace(int paramInt, RectF paramRectF)
  {
    ...
    if (Build.VERSION.SDK_INT >= 23) {
      localObject2 = createStaticLayoutForMeasuring((CharSequence)localObject1, (Layout.Alignment)localObject2, Math.round(paramRectF.right), i);
    } else {
      localObject2 = createStaticLayoutForMeasuringPre23((CharSequence)localObject1, (Layout.Alignment)localObject2, Math.round(paramRectF.right));
    }
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\AppCompatTextViewAutoSizeHelper.class
