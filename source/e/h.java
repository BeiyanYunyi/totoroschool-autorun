...
public final class h
{
  ...
  public static h a(String paramString)
  {
    try
    {
      h localh2 = (h)br.get(paramString);
      h localh1 = localh2;
      if (localh2 == null)
      {
        localh2 = (h)br.get(b(paramString));
        localh1 = localh2;
        if (localh2 == null) {
          localh1 = new h(paramString);
        }
        br.put(paramString, localh1);
      }
      return localh1;
    }
    finally {}
  ...
  private static String b(String paramString)
  {
    ...
    if (paramString.startsWith("TLS_"))
    {
      ...
      localStringBuilder.append(paramString.substring(4));
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\e\h.class
