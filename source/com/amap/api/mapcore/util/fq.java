...
public class fq
{
  ...
  {
    Cipher localCipher = Cipher.getInstance(fw.c(ge.a));
  ...
  static byte[] a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    ...
    {
      gg.a(paramArrayOfByte1, "er", "asEn");
    }
    return null;
  }
  ...
  private static byte[] b(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
    throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException
  {
    return c(paramArrayOfByte1, paramArrayOfByte2, fw.c());
  }
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\com\amap\api\mapcore\util\fq.class
