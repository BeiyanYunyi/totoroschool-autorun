  ...
  extends Fragment
{
  ...
  protected IMapFragmentDelegate getMapFragmentDelegate()
  {
    ...
    try
    {
      this.b = ((IMapFragmentDelegate)hi.a(dx.e()).a(getActivity(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", lq.class, new Class[] { Integer.TYPE }, new Object[] { Integer.valueOf(0) }));
      if (this.b == null) {
        this.b = ((IMapFragmentDelegate)ha.a(getActivity(), dx.e(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", lq.class, new Class[] { Integer.TYPE }, new Object[] { Integer.valueOf(0) }));
      }
      if (this.b == null)
      {
        this.b = new lq(0);
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\com\amap\api\maps\MapFragment.class
