  ...
  extends Fragment
{
  ...
  public static TextureSupportMapFragment newInstance(AMapOptions paramAMapOptions)
  {
  ...
  protected IMapFragmentDelegate getMapFragmentDelegate(Context paramContext)
  {
    ...
    try
    {
      this.b = ((IMapFragmentDelegate)hi.a(dx.e()).a(paramContext, "com.amap.api.wrapper.MapFragmentDelegateWrapper", lq.class, new Class[] { Integer.TYPE }, new Object[] { Integer.valueOf(1) }));
      if (this.b == null) {
        this.b = ((IMapFragmentDelegate)ha.a(paramContext, dx.e(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", lq.class, new Class[] { Integer.TYPE }, new Object[] { Integer.valueOf(1) }));
      }
      if (this.b == null)
      {
        this.b = new lq(1);
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\com\amap\api\maps\TextureSupportMapFragment.class
