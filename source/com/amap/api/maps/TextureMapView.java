  ...
  extends FrameLayout
{
  ...
  public TextureMapView(Context paramContext, AMapOptions paramAMapOptions)
  {
    super(paramContext);
    a(paramContext);
    getMapFragmentDelegate().setContext(paramContext);
  ...
  protected IMapFragmentDelegate getMapFragmentDelegate()
  {
    ...
    try
    {
      this.a = ((IMapFragmentDelegate)hi.a(dx.e()).a(getContext(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", lq.class, new Class[] { Integer.TYPE }, new Object[] { Integer.valueOf(1) }));
      if (this.a == null) {
        this.a = ((IMapFragmentDelegate)ha.a(getContext(), dx.e(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", lq.class, new Class[] { Integer.TYPE }, new Object[] { Integer.valueOf(1) }));
      }
      if (this.a == null) {
        this.a = new lq(1);
      }
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\com\amap\api\maps\TextureMapView.class
