    ...
    if (str != null)
    {
      ...
      if (!bool)
      {
        if (str.startsWith("wtai://wp/mc;"))
        {
          ...
          paramIX5WebViewBase.append(str.substring("wtai://wp/mc;".length()));
    ...
    if (paramString != null)
    {
      ...
      if (!bool)
      {
        if (paramString.startsWith("wtai://wp/mc;"))
        {
          paramIX5WebViewBase = new StringBuilder();
          paramIX5WebViewBase.append("tel:");
          paramIX5WebViewBase.append(paramString.substring("wtai://wp/mc;".length()));
          paramIX5WebViewBase = new Intent("android.intent.action.VIEW", Uri.parse(paramIX5WebViewBase.toString()));
          this.b.getContext().startActivity(paramIX5WebViewBase);
          return true;
        }
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\com\tencent\smtt\sdk\v.class
