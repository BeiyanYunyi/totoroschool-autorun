  ...
  extends BaseActivity
{
  ...
  private ForgetPasswordRequestModel h;
  @BindView(2131296559)
  ...
  private void a(final GetCampusListReturnModel paramGetCampusListReturnModel)
  {
    if ((paramGetCampusListReturnModel != null) && (paramGetCampusListReturnModel.getCampuslist() != null) && (paramGetCampusListReturnModel.getCampuslist().length() > 0))
    {
      ...
      this.campusSpinner.addOnItemClickListener(new AdapterView.OnItemClickListener()
      {
        ...
        {
          InfoAuthActivity.b(InfoAuthActivity.this, ((CampusListModel)paramGetCampusListReturnModel.get(paramAnonymousInt)).getId());
        }
      });
  ...
  private void a(final GetSchoolListReturnModel paramGetSchoolListReturnModel)
  {
    if ((paramGetSchoolListReturnModel != null) && (paramGetSchoolListReturnModel.getSchoollist() != null) && (paramGetSchoolListReturnModel.getSchoollist().length() > 0))
    {
      ...
      this.schoolSpinner.addOnItemClickListener(new AdapterView.OnItemClickListener()
      {
        public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong)
        {
          InfoAuthActivity.a(InfoAuthActivity.this, ((SchoolListModel)paramGetSchoolListReturnModel.get(paramAnonymousInt)).getId());
          InfoAuthActivity.b(InfoAuthActivity.this).b(InfoAuthActivity.a(InfoAuthActivity.this));
        }
      });
  ...
  public void a(String paramString, Object paramObject)
  {
    ...
    case 2: 
      ...
      if (paramString != null)
      {
        ...
        paramString = new Intent(this, ChangePasswordActivity.class);
        paramString.putExtra("forgetPwdModel", this.h);
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.h = ((ForgetPasswordRequestModel)getIntent().getSerializableExtra("forgetPwdModel"));
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\com\totoro\school\activity\login\InfoAuthActivity.class
