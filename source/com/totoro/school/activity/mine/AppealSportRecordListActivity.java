...
public final class AppealSportRecordListActivity
  extends BaseActivity
{
  ...
  private final void b()
  {
    ...
    localTextView.setText((CharSequence)getResources().getString(2131689602));
  }
  ...
  private final void e()
  {
    ...
    localObject1 = LitePal.where(new String[] { " alreadyAppeal = ? ", "1" }).order("begdate desc,userendtime desc").find(RunRegRequestModel.class);
    h.a(localObject1, "LitePal.where(\" alreadyA…RequestModel::class.java)");
  ...
  {
    a(AppealSportRecordListActivity paramAppealSportRecordListActivity) {}
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\com\totoro\school\activity\mine\AppealSportRecordListActivity.class
