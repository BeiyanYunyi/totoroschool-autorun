  ...
  extends Handler
{
  ...
  public a(CaptureActivity paramCaptureActivity, Vector<BarcodeFormat> paramVector, String paramString)
  {
    this.b = paramCaptureActivity;
    this.c = new d(paramCaptureActivity, paramVector, paramString, new com.totoro.school.zxing.view.a(paramCaptureActivity.b()));
    this.c.start();
    this.d = a.SUCCESS;
    c.a().c();
    b();
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\com\totoro\school\zxing\b\a.class
