...
public class SelectSchoolAdapter
  extends BaseAdapter
{
  private List<SchoolListModel> a;
  private Context b;
  private int c;
  private boolean d;
  private String e;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.tvConent.setText(((SchoolListModel)this.a.get(paramInt)).getName());
    ...
    if (((SchoolListModel)this.a.get(paramInt)).getName().equals(this.e))
    {
      paramViewGroup.setTypeface(Typeface.DEFAULT_BOLD);
      paramViewGroup.setFakeBoldText(true);
      return paramView;
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\com\totoro\school\adapter\common\SelectSchoolAdapter.class
