  ...
  extends l<R>
{
  ...
  public c(l<T> paraml, h<? super T, ? extends w<? extends R>> paramh, i parami, int paramInt)
  {
    this.a = paraml;
    this.b = paramh;
    this.c = parami;
    ...
    implements b.a.b.b, s<T>
  {
    ...
    a(s<? super R> params, h<? super T, ? extends w<? extends R>> paramh, int paramInt, i parami)
    {
    ...
    void drain()
    {
      ...
      do
      {
        for (;;)
        {
          ...
          int k = this.state;
          if ((localc.get() != null) && ((locali == i.IMMEDIATE) || ((locali == i.BOUNDARY) && (k == 0))))
          {
            ((f)localObject1).clear();
            this.item = null;
          ...
          if (k == 0)
          {
            ...
            try
            {
              localObject2 = (w)b.a.e.b.b.a(this.mapper.apply(localObject2), "The mapper returned a null SingleSource");
              this.state = 1;
              ((w)localObject2).a(this.inner);
            }
...
/* Location:              C:\Users\lixia\Desktop\android反编译三件套\dex2jar-2.0\classes-dex2jar.jar!\b\a\e\e\c\c.class
